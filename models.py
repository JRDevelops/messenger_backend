...
class User(Base):
  ...
  last_seen_at: Mapped[DateTime] = mapped_column(DateTime(timezone=True), default=datetime.now(UTC))
...
class Contact(Base):
  ...
  #contact_username: Mapped[str] = mapped_column(String(50), nullable=False)
